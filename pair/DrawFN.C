...
void DrawFN()
{
	...
	chain->Add(Form("tree/FN/R000549.root"));
	chain->LoadTree(0);
	...
	TH1D * hPromptQ = new TH1D("hPromptQ","hPromptQ",100,30000,100000);
	TH1D * hDelayedQ = new TH1D("hDelayedQ","hDelayedQ",100,10000,18000);
...
//	gStyle->SetOptFit(1);
	...
	TF1 * f1 = new TF1("f1",func_exp1,10,100,2);
